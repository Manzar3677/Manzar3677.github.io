...
(function(a){
    a.fn.amazon_scroller=function(p){
        ...
        var m=p&&p.scroller_images_width?p.scroller_images_width:"500";
        var n=p&&p.scroller_images_height?p.scroller_images_height:"300";
        ...
        dom.find("ul:first").children("li").children("a").children("img").css("width",'100%').css("height",'300px');
        if(h=='enable'){
        ...
        function begin(){
            ...
            dom.width('100%');
            dom.height('300px');
            dom.children(".amazon_scroller_mask").width('100%');
            dom.children(".amazon_scroller_mask").height('300px');
            ...
            dom.find(".amazon_scroller_nav").width('100%');
